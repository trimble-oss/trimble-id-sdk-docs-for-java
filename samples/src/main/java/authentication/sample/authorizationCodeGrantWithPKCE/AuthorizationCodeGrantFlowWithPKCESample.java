...
public class AuthorizationCodeGrantFlowWithPKCESample {
    ...
    public AuthorizationCodeGrantFlowWithPKCESample() {

        // Initialize the endpoint provider
        endpointProvider = new OpenIdEndpointProvider(URI.create("<OPENID_CONFIGURATION_URL>"));

        // Authorization Code Grant Token Provider with PKCE (Client secret is not required)
